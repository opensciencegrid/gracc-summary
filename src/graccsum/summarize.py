...
def main():
    ...
    parser.add_argument('from', dest='from_str', help="Dateutil parsable date beginning of summarization period", required=True)
    parser.add_argument('to', dest='to_str', help="Dateutil parsable date end of summarization period", required=True)
    ...
    # Create the client
    client = Client(exchange=args.exchange, routing_key=args.routing_key, host=args.host, username=args.username, password=args.password)
